...
def test_module_with_classes():
    ...
    sut.expect_async("Spawned child process")
    sut.expect_async("ImplementationA value: 10", 2)
    sut.expect_async("ImplementationB value: 15")
    sut.expect_async("ChildA value: 10")
    sut.expect_async("ImplementationA is printing")
    sut.expect_async("I am working! I_AM_B")
    sut.expect_async("ChildA is printing")
    sut.expect_async("ImplementationA is printing")
    sut.expect_async("Interface value: 10")
    sut.expect_async("Hello from Module")
    sut.stop(1)
