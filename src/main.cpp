...
msos::dl::ModuleInfo load_module(Writer& writer, const uint32_t address)
{
    ...
    return msos::dl::DynamicLinker::load_module(writer, address, environment);
}
...
int main()
{
    ...
    const auto module_info = load_module(writer, module_address);
